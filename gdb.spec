...
Release: 29%{?_with_upstream:.upstream}%{dist}.1
...
# Fix crash on stale bpstat (BZ 662218).
Patch528: gdb-bz662218-stale-bpstat-1of3.patch
Patch529: gdb-bz662218-stale-bpstat-2of3.patch
Patch530: gdb-bz662218-stale-bpstat-3of3.patch
...
%changelog
* Fri Dec 10 2010 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.1-29.el6_0.1
- Fix crash on stale bpstat (BZ 662218).
- Fix Release for the Z-Stream.

* Tue Jul 20 2010 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.1-29.el6
- Change the version string to "Red Hat Enterprise Linux" (BZ 537788).
